...
@TeleOp(name = "Full Control DIRECT WIFI")
@Disabled
...
public class FullControl extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("Left Drive", " right position:  " + String.format("%.3f", leftSquaredDriveValue));
        telemetry.addData("Right Drive", " right position:  " + String.format("%.3f", rightSquaredDriveValue));
    }
}
