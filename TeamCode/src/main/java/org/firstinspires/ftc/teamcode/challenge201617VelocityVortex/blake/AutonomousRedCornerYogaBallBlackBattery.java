...
@Autonomous(name = "Red Corner + Yoga Ball  - Black Battery")
@Disabled


public class AutonomousRedCornerYogaBallBlackBattery extends LinearOpMode {
...
*/
            ...
            } while (zAccumulated < 10 && opModeIsActive());
