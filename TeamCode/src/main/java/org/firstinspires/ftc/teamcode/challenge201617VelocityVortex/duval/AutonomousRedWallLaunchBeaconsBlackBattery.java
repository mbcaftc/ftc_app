...
public class AutonomousRedWallLaunchBeaconsBlackBattery extends LinearOpMode {
    ...
    final static double MOVEDISTANCE2 = 22; //launching point to just before white line
    final static double MOVEDISTANCE3 = 0.85; //white line to press beacon
...
//resets encoders
        ...
        while (opModeIsActive()) {
            ...
            } while (zAccumulated > -50 && opModeIsActive());
            ...
            do {
                ...
                leftDriveMotor.setPower(0.3);
                rightDriveMotor.setPower(-0.3);
            } while (zAccumulated < -1.2 && opModeIsActive());
            ...
            do {
                ...
                leftDriveMotor.setPower(-0.3);
                rightDriveMotor.setPower(0.3);
            } while (zAccumulated > -74 && opModeIsActive());
            ...
            if (beaconRED) {
                ...
                } while (!beaconRED && opModeIsActive());
