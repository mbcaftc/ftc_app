...
import org.firstinspires.ftc.teamcode.challengeRelicRecovery201718.subClasses.relicArm;
        ...
        while (opModeIsActive()) {
            ...
            switch (movement) {
                ...
                case 12: //Turn around and pick up glyph
                    ...
                    movement++;
                    break;
                case 13: //Go toward glyph pile and pick up glyph
                    myGlyphLift.lowerGlyphLiftAutMode();
                    myMechDrive.encoderDriveMat(25, 1, 0.3);
                    myGlyphArms.closeGlyphArms();
                    sleep(100);
                    myGlyphLift.raiseGlyphLiftAutMode();
                    myGlyphLift.raiseGlyphLiftAutMode();
