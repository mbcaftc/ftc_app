...
@TeleOp(name = "Full Control - Dual Controls")
@Disabled

public class FullControlDualDrive extends OpMode {
    ...
    double joystickInputLimitHighPower = 0.7;
    double joystickInputLimitLowPower = 0.2;
    ...
    double maximumForwardBeltPower = 0.5;
    ...
    boolean toggleDriveTank;
    boolean toggleDriveLinear;


    @Override

    public void init() {
        toggleDriveTank = true;
        toggleDriveLinear = false;
    ...
    public void loop() {
        ...
        if (gamepad1.y) {
            toggleDriveLinear = true;
            toggleDriveTank = false;
        }
    ...
    private void driveTank () {
        ...
        if (!driveLowPower) {
            ...
            rightSquaredDriveValue = joystickInputLimitHighPower * (rightStickDriveValue * rightStickDriveValue);
            leftSquaredDriveValue = joystickInputLimitHighPower * (leftStickDriveValue * leftStickDriveValue);

            leftSquaredDriveValue = Range.clip(leftSquaredDriveValue, -joystickInputLimitHighPower, joystickInputLimitHighPower);
            rightSquaredDriveValue = Range.clip(rightSquaredDriveValue, -joystickInputLimitHighPower, joystickInputLimitHighPower);
            ...
            rightSquaredDriveValue = joystickInputLimitLowPower * (rightStickDriveValue * rightStickDriveValue);
            leftSquaredDriveValue = joystickInputLimitLowPower * (leftStickDriveValue * leftStickDriveValue);

            leftSquaredDriveValue = Range.clip(leftSquaredDriveValue, -joystickInputLimitLowPower, joystickInputLimitLowPower);
            rightSquaredDriveValue = Range.clip(rightSquaredDriveValue, -joystickInputLimitLowPower, joystickInputLimitLowPower);

            if (leftSquaredDriveValue > 0 && leftSquaredDriveValue < 0.1) {
                leftSquaredDriveValue = 0.1;
            }

            if (rightSquaredDriveValue > 0 && rightSquaredDriveValue < 0.1) {
                rightSquaredDriveValue = 0.1;
            }
